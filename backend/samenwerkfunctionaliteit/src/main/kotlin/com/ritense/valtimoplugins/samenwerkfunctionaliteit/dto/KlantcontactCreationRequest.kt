...
data class KlantcontactCreationRequest(
    ...
    data class BetrokkeneRequest(
        ...
        val wasPartij: com.ritense.valtimoplugins.samenwerkfunctionaliteit.dto.UuidReference? = null,
        ...
        @JsonProperty("rol")
        @field:NotBlank
        val rol: com.ritense.valtimoplugins.samenwerkfunctionaliteit.dto.Betrokkene.Rol,
    ...
    data class OnderwerpobjectRequest(
        ...
        val wasKlantcontact: com.ritense.valtimoplugins.samenwerkfunctionaliteit.dto.UuidReference? = null,
